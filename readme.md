...
Необходимо реализовать классы библиотеки `containers.h` (спецификации указаны в соответствующих разделах материалов, см. пункт [**Основные контейнеры**](containers_info_rus.md)). \
...
Необходимо реализовать функции библиотеки `containersplus.h` (спецификации указаны в соответствующих разделах материалов, см. пункт [**Дополнительные контейнеры**](containers_info_extra_rus.md)). \
